...
export class EnseignantIaParentService {
  // Liste des profils pédagogiques simples
  readonly profils = signal<ProfilPedagogique[]>([
    {
      id: 'prof-diarra',
      nom: 'Professeur Diarra',
    ...
    {
      id: 'prof-traore',
      nom: 'Professeure Traoré',
      matiere: 'Physique-Chimie',
      photoUrl: '',
      audioUrl: '',
      audioFileName: 'extrait-physique-traore.mp3',
      actif: false,
    },
    {
      id: 'prof-coulibaly',
      nom: 'Professeure Coulibaly',
      matiere: 'Français',
      photoUrl: '',
      audioUrl: '',
    ...
    },
    {
      ...
      photoUrl: '',
      audioUrl: '',
      audioFileName: 'extrait-svt-kone.mp3',
      actif: false,
    },
  ]);

  readonly configuration = signal<ConfigurationEnseignantParent>({
    profilActifId: 'prof-coulibaly',
