...
<div class="page-content stagger-children pilotage-theme">
  ...
  styles: [`
    ...
    .pilotage-header { background: linear-gradient(135deg, #0F172A, #1E293B); border: 1px solid rgba(255,255,255,0.1); border-radius: var(--radius-xl); padding: 28px 32px; margin-bottom: 24px; box-shadow: var(--shadow-xl); color: white; }
    .status-indicator-badge { display: inline-flex; align-items: center; gap: 6px; padding: 4px 10px; border-radius: var(--radius-full); background: rgba(16, 185, 129, 0.15); border: 1px solid rgba(16, 185, 129, 0.4); color: #34d399; font-size: 11px; font-weight: 700; font-family: var(--font-mono); }
    .pilotage-title { font-family: var(--font-display); font-size: 24px; font-weight: 800; color: white; margin-top: 4px; }
    .pilotage-subtitle { font-size: 13px; color: rgba(255,255,255,0.7); margin-top: 2px; }
    .control-time-chip { padding: 6px 14px; background: rgba(255,255,255,0.1); border: 1px solid rgba(255,255,255,0.15); border-radius: var(--radius-md); color: white; }
