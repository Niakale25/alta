...
<div class="page-content stagger-children">
  ...
  styles: [`
    ...
    .alerte-filtre-btn { display: flex; align-items: center; gap: 6px; padding: 7px 14px; border-radius: var(--radius-full); border: 1.5px solid var(--color-border); background: var(--color-bg-surface); cursor: pointer; font-size: var(--text-sm); font-weight: var(--fw-medium); color: var(--color-text-secondary); transition: all var(--transition-fast); }
    .alerte-filtre-btn:hover { border-color: var(--color-secondaire); color: var(--color-secondaire); }
    ...
    .alerte-card:hover { box-shadow: var(--shadow-md); }
    .alerte-card--unread { background: var(--color-bg-surface); border-left: 4px solid var(--color-secondaire); }
    .alerte-card--haute { border-left-color: var(--color-danger) !important; }
    .alerte-card__icon { width: 44px; height: 44px; border-radius: var(--radius-md); display: flex; align-items: center; justify-content: center; font-size: 22px; flex-shrink: 0; background: var(--color-bg-surface-2); }
