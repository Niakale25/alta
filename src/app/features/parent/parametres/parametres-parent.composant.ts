...
<div class="page-content stagger-children">
  ...
  styles: [`
    ...
    .settings-nav { display: flex; flex-direction: column; gap: 4px; background: var(--color-bg-surface); border: 1px solid var(--color-border); border-radius: var(--radius-lg); padding: 12px; height: fit-content; }
    ...
    .settings-section { background: var(--color-bg-surface); border: 1px solid var(--color-border); border-radius: var(--radius-xl); padding: 28px; box-shadow: var(--shadow-sm); }
    .settings-section__title { font-size: var(--text-lg); font-weight: var(--fw-bold); color: var(--color-text-primary); margin-bottom: 20px; border-bottom: 1px solid var(--color-border); padding-bottom: 12px; }
    ...
    .preferences-list { display: flex; flex-direction: column; gap: 14px; }
    ...
    .danger-zone { margin-top: 32px; padding-top: 20px; border-top: 1px dashed var(--color-danger-light); }
